...
fn_config = os.path.join(app_path(APP_DIR_SETTINGS), 'cuda_AILocal_helper.ini')
MAX_BUFFER = 100*1000
IS_WIN = os.name=='nt'
...
class Command:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.temperature = configini.get('op', 'temperature')
        except:
...
#                 lineResp = lineResp + str(json.loads(decoded_line)["response"])
#      
#        
#         allLines = lineResp.split("\n")
# 
#         self.memo.set_prop(PROP_RO, False)
